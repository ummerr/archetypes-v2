    ...
    <div>
      <div className="flex flex-wrap gap-3 items-baseline mb-6">
        <input
          ...
          className="flex-1 min-w-[200px] bg-transparent border border-surface-light/40 rounded-sm px-3 py-2 font-serif text-[15px] focus:outline-none focus:border-gold/50"
        />
        <div className="flex gap-1 font-mono text-[10px] tracking-[0.25em] uppercase">
          ...
          <li key={r.slug}>
            ...
            >
              <div className="flex items-baseline justify-between gap-2 mb-1">
                <p className="font-serif text-[16px] font-medium">{r.displayName}</p>
                <p className="font-mono text-[9px] tracking-[0.25em] uppercase text-text-secondary/55">
                  {r.kind}
                </p>
              </div>
              {r.mediums.length > 0 && (
                <p className="font-mono text-[9px] tracking-[0.2em] uppercase text-text-secondary/55 mb-2">
                  {r.mediums.join(" · ")}
                </p>
              )}
              {r.editorialNote && (
                <p className="text-[13px] text-text-secondary/80 italic leading-snug mb-3">
                  {r.editorialNote}
                </p>
              )}
