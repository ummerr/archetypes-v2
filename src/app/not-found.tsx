...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 text-center">
      <p className="font-mono text-kicker tracking-display text-gold/80 uppercase mb-6">
        404 · Off the Map
      </p>
      <h1 className="font-serif text-5xl md:text-7xl font-medium text-text-primary tracking-tight leading-display mb-6">
