...
export const SYSTEMS: ArchetypeSystem[] = [
  ...
  },
  {
    id: "astrology",
    name: "Astrology",
    subtitle: "The Twelve Signs",
    description:
      "Twelve signs generated by four elements and three modalities - the tropical zodiac read as character structure, its Jungian vocabulary a twentieth-century retrofit onto an ancient divinatory frame.",
    href: "/astrology",
    status: "live",
    accent: "#7C8CB0",
    accentLight: "#3E5170",
    count: 12,
    framework: "Tropical Zodiac",
  },
];
